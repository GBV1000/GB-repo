...
class Matrix:
	...
	def __add__(self, other):
		len_my_list = len(self.my_list)
		for row in range(len_my_list):
...
matrix_0 = Matrix([[11,22], [21, 30], [41, 50]])
matrix_1 = Matrix([[39,28], [29, 20], [9, 0]])
print(matrix_0.__add__(matrix_1))
